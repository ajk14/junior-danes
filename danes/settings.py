...
DATABASES = {
    'default': {
        ...
        'NAME': '/Users/andykaier/Documents/danes/dev.db',                      # Or path to database file if using sqlite3.
...
STATIC_ROOT = '/Users/andykaier/Documents/danes/static'
...
SECRET_KEY = '*jfd88+0u0^k#tx5erh$0-#gfxm*zt80@rijsfty%#kc**2oys'
...
ROOT_URLCONF = 'danes.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'danes.wsgi.application'
